...
public class ProjectileSettingsMenu extends Screen {
    ...
    public ProjectileSettingsMenu(Screen screen) {
        super(Text.of("ProjectileSettingsMenu"));
        this.screen = screen;
    }
    ...
    protected void init() {
        ...
        red = new HSliderWidget(width / 2 - 2, height / 2 - 83, 60, 16, Text.empty(), ModConfig.configData.getProjectileColor()[0], 0.0f, 255.0f, red1, HSliderWidget.EntityType.PROJECTILE, HSliderWidget.ColorType.RED);
        green = new HSliderWidget(width / 2 - 2, height / 2 - 58, 60, 16, Text.empty(), ModConfig.configData.getProjectileColor()[1], 0.0f, 255.0f, green1, HSliderWidget.EntityType.PROJECTILE, HSliderWidget.ColorType.GREEN);
        ...
        ButtonWidget buttonWidget = ButtonWidget.builder(Text.of((ModConfig.configData.isEnableRenderProjectile()) ? "§aEnabled" : "§cDisabled"), button -> {
            ...
            button.setMessage(Text.of(((ModConfig.configData.isEnableRenderProjectile()) ? "§aEnabled" : "§cDisabled")));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Color color = new Color((int) ModConfig.configData.getProjectileColor()[0], (int) ModConfig.configData.getProjectileColor()[1], (int) ModConfig.configData.getProjectileColor()[2], (int) ModConfig.configData.getProjectileColor()[3]);
