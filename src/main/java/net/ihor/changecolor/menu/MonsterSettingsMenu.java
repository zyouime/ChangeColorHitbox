...
public class MonsterSettingsMenu extends Screen {
    ...
    public MonsterSettingsMenu(Screen screen) {
        super(Text.of("MonsterSettingsMenu"));
        this.screen = screen;
    }
    ...
    protected void init() {
        ...
        red = new HSliderWidget(width / 2 - 2, height / 2 - 83, 60, 16, Text.empty(), ModConfig.configData.getMonsterColor()[0], 0.0f, 255.0f, red1, HSliderWidget.EntityType.MONSTER, HSliderWidget.ColorType.RED);
        green = new HSliderWidget(width / 2 - 2, height / 2 - 58, 60, 16, Text.empty(), ModConfig.configData.getMonsterColor()[1], 0.0f, 255.0f, green1, HSliderWidget.EntityType.MONSTER, HSliderWidget.ColorType.GREEN);
        ...
        ButtonWidget buttonWidget = ButtonWidget.builder(Text.of((ModConfig.configData.isEnableRenderMonster()) ? "§aEnabled" : "§cDisabled"), button -> {
            ...
            button.setMessage(Text.of(((ModConfig.configData.isEnableRenderMonster()) ? "§aEnabled" : "§cDisabled")));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        int r = (int) ModConfig.configData.getMonsterColor()[0];
        int g = (int) ModConfig.configData.getMonsterColor()[1];
