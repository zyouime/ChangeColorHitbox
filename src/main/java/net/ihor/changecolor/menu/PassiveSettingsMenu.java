...
public class PassiveSettingsMenu extends Screen {
    ...
    public PassiveSettingsMenu(Screen screen) {
        super(Text.of("PassiveSettingsMenu"));
        this.screen = screen;
    }
    ...
    protected void init() {
        ...
        red = new HSliderWidget(width / 2 - 2, height / 2 - 83, 60, 16, Text.empty(), ModConfig.configData.getPassiveColor()[0], 0.0f, 255.0f, red1, HSliderWidget.EntityType.PASSIVE, HSliderWidget.ColorType.RED);
        green = new HSliderWidget(width / 2 - 2, height / 2 - 58, 60, 16, Text.empty(), ModConfig.configData.getPassiveColor()[1], 0.0f, 255.0f, green1, HSliderWidget.EntityType.PASSIVE, HSliderWidget.ColorType.GREEN);
        ...
        ButtonWidget buttonWidget = ButtonWidget.builder(Text.of((ModConfig.configData.isEnableRenderPassive()) ? "§aEnabled" : "§cDisabled"), button -> {
            ...
            button.setMessage(Text.of(((ModConfig.configData.isEnableRenderPassive()) ? "§aEnabled" : "§cDisabled")));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        int r = (int) ModConfig.configData.getPassiveColor()[0];
        int g = (int) ModConfig.configData.getPassiveColor()[1];
        int b = (int) ModConfig.configData.getPassiveColor()[2];
        int a = (int) ModConfig.configData.getPassiveColor()[3];
        ...
        VillagerEntity villagerEntity = new VillagerEntity(EntityType.VILLAGER, client.world);
        RenderEntityToMenu.drawEntity(width / 2 - 43, height / 2 - 30, 1.5f * 20, villagerEntity);
